...
const std::vector<MathParseFunctions::FunctionProperties> MathParseFunctions::_functions = {
...
MathParseFunctions::FunctionType
MathParseFunctions::identifyFunction(const std::string & func)
{
  std::size_t i = 0;
