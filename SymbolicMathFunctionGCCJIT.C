...
Function::compile()
{
  ...
  // for debugging
  // gcc_jit_context_set_bool_option(_state.ctxt, GCC_JIT_BOOL_OPTION_DUMP_GENERATED_CODE, 1);
  ...
  _state.block = gcc_jit_function_new_block(_state.func, nullptr);
  gcc_jit_block_end_with_return(_state.block, nullptr, _root.jit(_state));
